 ...
 */
public class WorkflowFormBinderWithFormSelector extends DefaultFormBinderWithFormSelector implements FormLoadElementBinder, FormStoreElementBinder, FormDataDeletableBinder {

    @Override
    public String getName() {
        return "Workflow Form Binder with Form Selector";
    }
    ...
    public String getPropertyOptions() {
        ...
        return AppUtil.readPluginResource(getClass().getName(), "/properties/form/WorkflowFormBinderWithFormSelector.json", arguments, true, "messages/form/WorkflowFormBinderWithFormSelector");
    }
